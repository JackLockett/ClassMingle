   ...
   <body>
      ...
      <div class="container mt-5">
         <div class="row justify-content-center">
            <div class="col-md-6">
               <div class="card">
                  <div class="card-header">Resend Verification Email</div>
                  <div class="card-body">
                     @if (session('success'))
                     ...
                     <form method="POST" action="{{ route('resend-verification-email') }}">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" id="send-link-button">Send Verification Link</button>
                        <hr>
