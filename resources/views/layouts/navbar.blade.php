    ...
    <div class="collapse navbar-collapse" id="navbar-links">
        <div class="container">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="/societies" class="nav-link"><i class="fas fa-users"></i> Societies</a>
                </li>
                <li class="nav-item">
            ...
            @if(Auth::check())
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <button id="logout-button-dropdown" type="submit" class="dropdown-item">
                            <i class="fas fa-sign-out-alt"></i> Log Out
                        </button>
                    </div>
                </div>
            @else
                <button id="signInButton" onclick="redirectToLogin()" class="btn btn-primary d-none d-md-inline-block"><i
                            class="fas fa-sign-in-alt"></i> Sign In</button>
            @endif
        </div>
    </div>
